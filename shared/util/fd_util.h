...
#include "wksp/fd_wksp.h"          /* includes tpool/fd_tpool.h */
...
/* Boot/halt all fd_util services.  fd_boot is intended to be called
   ...
   precedence, command line will be stripped of these options):
     ...
     --log-path [cstr] / FD_LOG_PATH=[cstr]
       ...
       specified or specified as an empty string, will disable the
       permanent log for this process.  If specified as "-", the
