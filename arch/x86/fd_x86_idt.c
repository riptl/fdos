...
fd_x86_fred_ev_cstr( uint num ) {
  switch( num ) {
  case FD_X86_FRED_EV_INTR:
    return "INTR";
  case FD_X86_FRED_EV_NMI:
    return "NMI";
  case FD_X86_FRED_EV_EXC:
    return "EXC";
  case FD_X86_FRED_EV_INTN:
    return "INTN";
  case FD_X86_FRED_EV_INT1:
    return "INT1";
  case FD_X86_FRED_EV_INT3:
    return "INT3";
  case FD_X86_FRED_EV_OTHER:
    return "OTHER";
  default:
    return "??";
  }
