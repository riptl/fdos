...
#define FD_X86_FRED_EV_INTR  0
#define FD_X86_FRED_EV_NMI   2
#define FD_X86_FRED_EV_EXC   3
#define FD_X86_FRED_EV_INTN  4
#define FD_X86_FRED_EV_INT1  5
#define FD_X86_FRED_EV_INT3  6
#define FD_X86_FRED_EV_OTHER 7

char const *
fd_x86_fred_ev_cstr( uint num );
